...
- 在文本編輯器界面，使用快捷鍵 **Ctrl + O**，選擇文件打開。


### 保存文件
- 單擊 ![icon_menu](../common/icon_menu.svg) > **保存**，保存文件。
- 使用快捷鍵 **Ctrl + S** 或 **Ctrl + Shift + S** 保存當前文件。
...
如果在文本編輯時發生誤操作, 可以使用快捷鍵 **Ctrl + Z** 撤銷操作， 或者在右鍵菜單中選擇 **撤銷**。

### 查找文本

1. 單擊 ![menu](../common/icon_menu.svg) > **查找** 或使用快捷鍵 **Ctrl + F** 可以在下方打開查找窗口。
2. 在查找窗口中輸入您想要搜索的文本。
...
### 替換文本
1. 單擊 ![menu](../common/icon_menu.svg) > **替換** 或使用快捷鍵 **Ctrl + H** 可以在下方打開替換窗口。
