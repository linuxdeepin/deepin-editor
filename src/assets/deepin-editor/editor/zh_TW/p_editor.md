...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到文字編輯器 ![deepin_editor](../common/deepin_editor.svg)圖示并打開。
...
- 使用 **Ctrl + S** 或 **Ctrl + Shift + S** 組合鍵儲存目前檔案。
...
> ![tips](../common/tips.svg)竅門：選中一段文字後再進行搜尋，則這段文字會自動出現在尋找視窗中。
...
在主選單中，您可以 [建立新視窗](#管理標籤頁)、[建立新標籤頁](#管理標籤頁)、尋找取代內容、儲存檔案、切換視窗主題、查看說明手冊，了解文字編輯器的更多訊息。
