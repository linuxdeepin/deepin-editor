...
- 直接拖動檔案到文字編輯器介面或其圖示上。
- 右鍵單擊文件，選擇 **打開方式** > **文字編輯器**。選擇文字編輯器為預設打開程式後，可直接雙擊打開。
- 在文字編輯器介面，單擊 ![icon_menu](../common/icon_menu.svg) > **打開文件** 或使用快捷鍵 **Ctrl + O**，在彈出的視窗中選擇文件。

### 儲存檔案
- 單擊 ![icon_menu](../common/icon_menu.svg)> **儲存**，儲存檔案。

- 使用快捷鍵 **Ctrl + S** 或 **Ctrl + Shift + S** 儲存目前檔案。
...
### 取代文字
1. 單擊 ![menu](../common/icon_menu.svg)> **取代** 或使用快捷鍵 **Ctrl + H** 可以在下方打開取代視窗。
...
在右鍵選單中選擇 **前往該行** 或者使用快捷键 **Ctrl + G**，輸入行號即可前往到相應行。
